...
El frontend posteriormente se conectará al servicio por medio de los endpoints que dispone el backend (RestApi) y hará las consultas necesarias para mostrar la informacion requerida por el cliente.
